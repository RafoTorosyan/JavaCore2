...
public class StudentDemo {
    ...
    public static void main(String[] args) {
        ...
        while (run) {
            ...
            System.out.println("Please input 4 for delete students by index");
            ...
            switch (command) {
                ...
                case 5:
                    ...
                    break;
                default:
                    System.out.println("Invalid Command, Please again");
            }
        }
    ...
    private static void addStudent() {
        ...
        System.out.println("Please input student phoneNumbers");
        ...
        Student student = new Student(name, surname, age, phoneNumbers, city, lesson);
